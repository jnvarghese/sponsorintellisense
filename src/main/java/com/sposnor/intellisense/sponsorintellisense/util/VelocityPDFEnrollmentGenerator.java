...
public class VelocityPDFEnrollmentGenerator {

	
	public static void main(String[] args) throws Exception {
		
		VelocityPDFEnrollmentGenerator parser = new VelocityPDFEnrollmentGenerator();
	...
	private void generatePdf() throws Exception {
		...
		sr.setRenewalDue("April 2020");
		sr.setProfilePicture(largeByte);
		sponseeList.add(sr);sr = new SponseeReport();
		sr.setStudentName("studentName2");
		sr.setUniqueId("KKD-PPCL-5036");
		sr.setDateOfBirth("August 09 2007");
		sr.setGender("Female");
		...
		sr.setFavColor("Rose");
		sr.setFavGame("Foot Ball");
		sr.setNameOfGuardian("Murugadas Murugadas Muru");
		sr.setOccupationOfGuardian("Farmer");
		sr.setProjectName("KOTTAYAM KOCHI DIOCESE");
		sr.setAddress("Pazhampallichal - Kerala, India");
		sr.setRenewalDue("April 2020");
		...
		dataMap.put("sponseeList", sponseeList);
		dataMap.put("studentSize", 2);

		
		
		String receiptHtml = VelocityTemplateParser.generateHTML(dataMap, 1, "enrollment");
