...
public class VelocityPDFGeneratorRunner {

	
	public static void main(String[] args) throws Exception {
		
		VelocityPDFGeneratorRunner parser = new VelocityPDFGeneratorRunner();
	...
	private void generatePdf() throws Exception {
		...
		initiatives.add(i)
		;
		com.sposnor.intellisense.sponsorintellisense.data.model.Receipts receipt = new com.sposnor.intellisense.sponsorintellisense.data.model.Receipts();
	
		receipt.setReceiptId(1L);
		receipt.setRdate("04/13/2020");
		receipt.setFullName("Test Test");
		receipt.setFirstName("FirstName");
		receipt.setLastName("LastName");
		receipt.setMiddleName("MI");
		receipt.setStreetAddress("address");
		receipt.setCity("City");
		receipt.setState("State");
		receipt.setZipCode("Zip");
		receipt.setReceiptType(2);
		receipt.setInitiativeName("InitName");
		//receipt.setSubInitiativeName("subInitiativeName");
		receipt.setAmount(20.00);
		//receipt.setReceiptType(receiptType);
		receipt.setTransaction("transaction");
		receipt.setInitiatives(initiatives);
		receipt.setAmountInWords("twenty");
		...
		OutputStream out = new FileOutputStream("C://Users//HP//Desktop//out.pdf");
		out.write(pdfBytes);
		out.close();
	}
