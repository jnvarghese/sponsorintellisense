...
public class VelocityPDFGeneratorRunnerSCover {

	
	public static void main(String[] args) throws Exception {
		
		VelocityPDFGeneratorRunnerSCover parser = new VelocityPDFGeneratorRunnerSCover();
	...
	private void generatePdf() throws Exception {
		...
		String receiptHtml = VelocityTemplateParser.generateSubstitutionCoverLetter(sr, 2);
