...
public class SponseeReport {
	...
	public String getCluster() {
		return (cluster == null || cluster.length() == 0) ? cluster : "";
	}
	...
	public String getGrade() {
		return (grade == null || grade.length() == 0) ? grade : " ";
	}
	...
	public String getFavColor() {
		return (favColor == null || favColor.length() == 0) ? favColor : "";
	}
	...
	public String getFavGame() {
		return (favGame == null || favGame.length() == 0) ? favGame : "";
	}
	...
	public String getNameOfGuardian() {
		return (nameOfGuardian == null || nameOfGuardian.length() == 0) ? nameOfGuardian : "";
	}
	...
	public String getOccupationOfGuardian() {
		return (occupationOfGuardian == null || occupationOfGuardian.length() == 0) ? occupationOfGuardian : "";
	}
	...
	public String getBaseLanguage() {
		return (baseLanguage == null || baseLanguage.length() == 0) ? baseLanguage : "";
	}
	...
	public String getHobby() {
		return (hobby == null || hobby.length() == 0) ? hobby : "";
	}
