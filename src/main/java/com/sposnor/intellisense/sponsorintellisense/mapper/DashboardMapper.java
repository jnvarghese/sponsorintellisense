...
public interface DashboardMapper {
	...
	static final String SELECT_FOR_EXPIRED = "SELECT R.NAME REGIONNAME, C.NAME CENTERNAME, P.NAME PARISHNAME, "
			+ "CONCAT(SP.FIRSTNAME,' ', SP.LASTNAME) SPONSORNAME, DATE_FORMAT(MAXOUT,'%M %D %Y') MAXOUT "
