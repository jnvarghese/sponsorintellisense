...
public interface SponsorMapper {
	...
	*/
	public static final String SELECT_ALL_ACTIVE_SPONSORS_BY_PARISHID = "SELECT S.ID,(CASE WHEN EN.ID IS NULL THEN RAND() ELSE EN.ID END) ENTID, EN.MISCAMOUNT, en.effectiveDate, "
